...
class ProgressDialog(Gtk.Box):
    ...
    def _build_ui(self):
        ...
        self.spinner.set_tooltip_text(_("Operation in progress"))
        ...
        self.progress_bar.set_tooltip_text(_("Operation progress"))
    ...
    def _on_key_pressed(self, controller, keyval, keycode, state):
        """Handle key press events. Escape closes or cancels."""
    ...
    def show_progress(
        self, title: str, initial_message: str = "", cancel_callback=None
    ):
        """
    ...
    def update_progress(self, fraction: float, text: Optional[str] = None):
        """
