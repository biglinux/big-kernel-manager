...
class BasePage(Gtk.Box):
    ...
    def _create_progress_container(self) -> Gtk.Box:
        ...
        """
        self._progress_container = Gtk.Box(
        ...
        self._progress_bar.set_tooltip_text(_("Operation progress"))
    ...
    def _create_terminal_expander(self) -> Gtk.Expander:
        ...
        self._terminal_view.set_tooltip_text(_("Command output"))
    ...
    def _update_progress(self, fraction: float, text: Optional[str] = None) -> None:
        """
    ...
    def _show_completion_dialog(
        self, title: str, message: str, status: str = "success"
    ) -> None:
        """
