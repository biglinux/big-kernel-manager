...
readonly ASSETS_DIR="${1:-/usr/share/big-kernel-manager/assets}"
readonly CACHE_DIR="/var/cache/big-kernel-manager"
...
echo "Big Kernel Manager: device ID cache built (${LINES} entries)"
...
echo "Big Kernel Manager: firmware cache built (${FW_LINES} entries)"
