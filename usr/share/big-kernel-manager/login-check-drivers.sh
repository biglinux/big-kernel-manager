...
readonly CACHE_FILE="/var/cache/big-kernel-manager/ids_cache.txt"
readonly DIALOG_SCRIPT="/usr/share/big-kernel-manager/udev-driver-dialog.py"
readonly BLACKLIST_FILE="${XDG_CONFIG_HOME:-$HOME/.config}/big-kernel-manager/ignored_devices.json"
readonly SHOWN_FILE="${XDG_CONFIG_HOME:-$HOME/.config}/big-kernel-manager/login_check_shown"
...
readonly FW_CACHE="/var/cache/big-kernel-manager/firmware_cache.txt"
